...
public class IncomesBeachFragment extends BaseFragment implements Paginate.Callbacks {
    ...
    private String paymentPlace = "escuela";
    ...
    public void onClickButton(){
        ((IncomesActivity) requireActivity()).startAddStudentActivity(this.paymentPlace);
    }
